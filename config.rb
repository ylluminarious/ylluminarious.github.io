...
# Why is this here? See https://github.com/middleman/middleman/issues/2087#issuecomment-307502952
...
config[:casper] = {
  blog: {
    ...
    name: "ylluminarious",
    description: 'illuminare (v.) "to light, to enlighten" | -ious (suff.) "characterized by"',
    date_format: "%d %B %Y",
    navigation: true,
    logo: "images/the-star-sun-faded-edges.png" # Optional
  },
  author: {
    name: "ylluminarious",
    bio: "I'm a software developer. I'm also the author of this blog.", # Optional
